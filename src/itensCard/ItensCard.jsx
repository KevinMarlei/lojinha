...
function ItensCard({ condition, thumbnail, price, permalink, title, handleAddToCart }) {
  return (
    <div className="boxCard p-4 m-4 bg-white shadow-2xl rounded-xl h-[32rem]">
      ...
      <CartButton item={{ condition, thumbnail, price, permalink, title }} handleAddToCart={handleAddToCart} />
    </div>
  );
}
